...
function App() {
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', maxWidth: '1200px', margin: '0 auto', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', backgroundColor: '#fff', color: '#333' }}> {/* Added color: '#333' */}
      <h1 style={{ textAlign: 'center', color: '#2c3e50' }}>AI Recipe Generator</h1>

      {!isAuthenticated ? (
        <div style={{ textAlign: 'center', marginBottom: '30px', padding: '20px', border: '1px solid #ddd', borderRadius: '8px', backgroundColor: '#f9f9f9', color: '#333' }}> {/* Added color: '#333' */}
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '10px', maxWidth: '300px', margin: '0 auto' }}>
            <input
              ...
              style={{ padding: '10px', borderRadius: '5px', border: '1px solid #ccc', color: '#333' }} /* Added color: '#333' */
            />
            <input
              type="password"
        ...
        <div style={{color: '#333'}}> {/* Added color: '#333' */}
